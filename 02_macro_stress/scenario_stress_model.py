...
across all major transmission channels: oil prices, yield curve, EM credit spreads,
and private credit stress. The model correctly identified the primary transmission
mechanism (Hormuz disruption duration driving oil prices driving inflation and
credit stress) and the directional impact on each asset class.
