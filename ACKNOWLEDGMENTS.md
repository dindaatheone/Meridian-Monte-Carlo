...
Challenged the deliberate use of raw PostgreSQL over ORM,
raising SQL injection risk and production architecture tradeoffs.
...
Technical review of the Monte Carlo methodology, model organization, and calibration framing.
Feedback informed the reframing of the Iran war case as an out-of-sample stress comparison
rather than methodology validation, and the removal of self-declared language from the
